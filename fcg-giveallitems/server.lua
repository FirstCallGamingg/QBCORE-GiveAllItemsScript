...
QBCore.Commands.Add(
    'giveallitem',
    'Give an item to ALL ONLINE players (ox_inventory)',
    {
        { name = 'item', help = 'Item name (must exist in ox_inventory items)' },
    ...
    function(source, args)
        ...
        -- GOD ONLY (console allowed)
        if src ~= 0 and not QBCore.Functions.HasPermission(src, 'god') then
        ...
        -- ox_inventory exposes items via exports.ox_inventory:Items()
